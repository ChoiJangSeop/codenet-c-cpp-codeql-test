...
int main(){
    ...
    cin >> buf_answer;
    var_y = buf_answer;
    if (((var_x * var_H) < ((var_W - var_x) * var_H))){
        if (((var_y * var_W) < ((var_H - var_y) * var_W))){
            if (((var_x * var_H) == (var_y * var_W))){
                cout << Var((var_x * var_H).asString() + Var(Var(" ").asString() + Var(1).asString()).asString()) << endl;
            } else {
                if (((var_x * var_H) < (var_y * var_W))){
                    cout << Var((var_x * var_H).asString() + Var(Var(" ").asString() + Var(0).asString()).asString()) << endl;
                } else {
                    cout << Var((var_y * var_W).asString() + Var(Var(" ").asString() + Var(0).asString()).asString()) << endl;
                }
            }
        } else {
            if (((var_y * var_W) < ((var_H - var_y) * var_W))){
                if ((((var_W - var_x) * var_H) == (var_y * var_W))){
                    cout << Var(((var_W - var_x) * var_H).asString() + Var(Var(" ").asString() + Var(1).asString()).asString()) << endl;
                } else {
                    if ((((var_W - var_x) * var_H) < (var_y * var_W))){
                        cout << Var(((var_W - var_x) * var_H).asString() + Var(Var(" ").asString() + Var(0).asString()).asString()) << endl;
                    } else {
                        cout << Var((var_y * var_W).asString() + Var(Var(" ").asString() + Var(0).asString()).asString()) << endl;
                    }
                }
